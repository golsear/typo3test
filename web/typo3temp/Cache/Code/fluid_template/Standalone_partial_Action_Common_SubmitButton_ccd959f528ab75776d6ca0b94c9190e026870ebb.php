<?php
class FluidCache_Standalone_partial_Action_Common_SubmitButton_ccd959f528ab75776d6ca0b94c9190e026870ebb extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '" type="submit" name="install[set][';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments4 = array();
...
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments7 = array();
$arguments7['value'] = $currentVariableContainer->getOrNull('text');
